...
def categoryPayloadMap = new JsonSlurper().parseText(categoryPayload.getText())
def petPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"name": "pet_name__unique__", "photoUrls": ["url1", "url2"], "category": ' + JsonOutput.toJson(categoryPayloadMap) + ', "status": "available"}'))
