...
def updatePetPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"id": ' + petId + ', "name": "pet__unique__", "photoUrls": ["url1", "url2"], "category": {"id": 1, "name": "category__unique__"}}'))
