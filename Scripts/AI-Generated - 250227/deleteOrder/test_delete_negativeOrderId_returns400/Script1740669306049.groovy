...
def deleteOrderRequest = findTestObject('Object Repository/Swagger Petstore/deleteOrder')
def deleteOrderResponse = WSBuiltInKeywords.sendRequest(deleteOrderRequest, ['orderId': -1])
