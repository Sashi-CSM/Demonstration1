...
createUsersWithListInputRequest.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID("[${userPayload}]")))
...
WSBuiltInKeywords.verifyResponseStatusCode(createUsersWithListInputResponse, 200)
