...
def formPayload = '{"name": "updated_name", "status": "updated_status"}'
...
def updatePetRequest = findTestObject('Object Repository/Swagger Petstore/updatePetWithForm', ['petId': petId])
def updatePetPayload = new HttpTextBodyContent(replaceSuffixWithUUID(formPayload))
